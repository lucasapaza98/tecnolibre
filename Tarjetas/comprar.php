...
<body>
    ...
    <main class="contenedor">
        ...
        <div class="cards">
             ...
             <figure class="tarjeta11">
                   <a class="card"  href="credito.php" title="Credito"><img src="../img/creditoo.png" alt="Tarjeta de Credito" width="150" height="150" ></a>
                   <a class="card" href="debito.php" title="Debito"><img src="../img/debito.png" alt="Tarjeta de Debito" width="150" height="150"  ></a>
