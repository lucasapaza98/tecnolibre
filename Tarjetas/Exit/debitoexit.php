...
<head>
    ...
    <title>TecnoLibre - Compra exitosa</title>
...
<style>
    ...
    .container-exit .sec1 p {
        margin-bottom: 40px;
        
    }
    .container-exit .sec1 p b{
        font-size: 25px;
        color:#fff;
...
<body>
    ...
    <main class="contenedor">
        ...
        <section class="sec1" >
            <p align="center"><b> <font size="7">ENHORABUENA</font></b></p>
            <p align="center"><b> <font size="5" color="green">la compra a sido exitosa</font></b></p>
        </section>


       <section class="sec2">
            <p align="center"><a href="../../laptops.php">Continuar</a></p>
            <p align="center"><a href="../debito.php">Atras</a></p>
        </section>
