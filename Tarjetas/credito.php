...
<head>
    ...
    <title>Laptops - comprar - crédito</title>
...
<!-- Formulario -->
<form action="Exit/creditoexit.php" id="formulario-tarjeta" class="formulario-tarjeta" method="POST" onsubmit=" return credito();">
    <div class="grupo">
